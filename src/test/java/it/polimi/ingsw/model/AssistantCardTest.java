...
public class AssistantCardTest
{
        ...
        public void Constructor()
        {
                ...
                assertAll(() -> assertEquals(Wizard.WIZARD_1, card.getWizard()), () -> assertEquals(10, card.getTurnOrder()),
        ...
        /**
         * The assistant card constructor should throw exception when invalid parameter are provided. Test if the constructor works accurately when a
         * wrong card is passed.
         */
        @Test
        public void illegalArgumentTest()
        {
                ...
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 0, 3));
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 11, 3));

                // Invalid mother nature steps
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 3, 0));
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 6, 6));

                // Incompatible turn value and steps number
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 10, 2));
                assertThrows(IllegalArgumentException.class, () -> new AssistantCard(Wizard.WIZARD_1, 2, 10));
