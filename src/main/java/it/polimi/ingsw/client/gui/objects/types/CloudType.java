...
{
    CLOUD_3("cloud3.png", new Point2D(-0.30, 0.05), new Point2D(0.22, 0.22), new Point2D(0.1, -0.3)),
    CLOUD_4("cloud4.png", new Point2D(-0.31, 0.071), new Point2D(0.158, 0.248), new Point2D(0.317,-0.139), new Point2D(-0.058, -0.316));
    ...
    public int getPositionsNumber() { return positions.length; }
