 ...
 * communication core. The model is an observable class, observed by the
 * so called "virtual-view" (or in this context the communication Match).
 * When a change is applied the model updates the Match with one of these
 * messages and eventually the player to which send the message.
 */
